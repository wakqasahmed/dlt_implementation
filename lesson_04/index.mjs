...
const init = async function (user_args) {
  console.log(peers);
  /*
  // Testing Number to BigEndian and vice versa
  for (let i = 0; i < 10; i++) {
...
const handleUserActions = function () {
  ...
  prompt.get(properties, function (err, result) {
    ...
    if (command[0] === 'balance') {
      ...
      Valid commands are\n
      1) balance\n
      2) send <publicKey> e.g. send 04440a759412d9ee76b11d60422439473ef97a5232292456017ecac653cd454a46f5fe1714a98fac29d8f3424b9cd391d526ce4af83dfe16cc57855b8da643d0fb\n`);
    }
